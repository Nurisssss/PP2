...
#IMAGES
player_img = pygame.image.load('/Users/User/Desktop/PP2/Lab8/Racer game/images/player.png')
enemy_img = pygame.image.load('/Users/User/Desktop/PP2/Lab8/Racer game/images/enemy.png')
coin_img = pygame.image.load('/Users/User/Desktop/PP2/Lab8/Racer game/images/coin.png')
background = pygame.image.load('/Users/User/Desktop/PP2/Lab8/Racer game/images/street.png')

#Sounds
accident_sound = pygame.mixer.Sound('/Users/User/Desktop/PP2/Lab8/Racer game/sounds/accident.wav')
coin_sound = pygame.mixer.Sound('/Users/User/Desktop/PP2/Lab8/Racer game/sounds/coin.wav')
music = pygame.mixer.Sound('/Users/User/Desktop/PP2/Lab8/Racer game/sounds/music.ogg')
music.play(-1)
...
while restart:
    ...
    while running:
        ...
        if pygame.sprite.spritecollideany(P1, coins):
            COINS += C1.value
            SCORE += C1.value*2
            C1.value = random.choice([1, 2, 3]) #changing the value
            C1.rect.top = 0
            C1.rect.center = (random.randint(30, 380), 0)
            coin_sound.play()
            if COINS % N == 0:
                E1.increase() #changing the speed of the game
